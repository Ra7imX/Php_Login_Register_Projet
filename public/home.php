                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>av. Abderrahim Bouabide ang. av. Atlas imm. Irac, 11000</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Call Us</h3>
                                <p>+212 713073428<br>+212 685968475</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                    ...
                    <form action="contact.php" method="post" class="php-email-form">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12 text-center">
                                <button type="submit" name="submit">end Message</button>
                            </div>
